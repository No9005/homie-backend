# Generated by Django 5.0.1 on 2024-01-16 17:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cash_flow_type', models.TextField(choices=[('income', 'income'), ('spending', 'spending')], default='spending', verbose_name='Cash Flow type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('firstname', models.TextField(max_length=20, verbose_name='Firstname')),
                ('lastname', models.TextField(max_length=20, verbose_name='Lastname')),
                ...
                ('email', models.TextField(blank=True, max_length=50, null=True, verbose_name='Email')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('IBAN', models.TextField(blank=True, max_length=20, null=True, unique=True, verbose_name='IBAN')),
